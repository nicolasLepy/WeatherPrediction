...
namespace WeatherViewer
{
    public static class ViewUtils
    {
        ...
        public static string WeatherToIcon(double weather)
        {
            ...
            else if (weather < 10.5)
            {
                icon = "32.png";
            }
            else if (weather < 11.5)
            {
                icon = "32.png";
            }
            else if (weather < 12.5)
            {
                icon = "34.png";
            }
            else if (weather < 13.5)
            {
                icon = "34.png";
            }
            else if (weather < 14.5)
            {
                icon = "30.png";
            }
            else if (weather < 15.5)
            {
                icon = "28.png";
            }
            else if (weather < 16.5)
            {
                icon = "25.png";
            }
            else if (weather < 17.5)
            {
                icon = "12.png";
            }
            else if (weather < 18.5)
            {
                icon = "12.png";
            }
            else if (weather < 19.5)
            {
                icon = "0.png";
            }
            else if (weather < 20.5)
            {
                icon = "32.png";
            }
            else if (weather < 21.5)
            {
                icon = "32.png";
            }
            else if (weather < 22.5)
            {
                icon = "34.png";
            }
            else if (weather < 23.5)
            {
                icon = "30.png";
            }
            else if (weather < 24.5)
            {
                icon = "28.png";
            }
            else if (weather < 25.5)
            {
                icon = "28.png";
            }
            else if (weather < 26.5)
            {
                icon = "28.png";
            }
            else if (weather < 27.5)
            {
                icon = "26.png";
            }
            else if (weather < 28.5)
            {
                icon = "25.png";
            }
            else if (weather < 29.5)
            {
                icon = "25.png";
            }
            else if (weather < 30.5)
            {
                icon = "0.png";
            }
            else if (weather < 31.5)
            {
                icon = "2.png";
            }
            else
